...
class User():
    ...
    - password: private string stored as an MD5 hash
    """
    ...
    def password(self, pwd):
        ...
        - Otherwise, store the MD5 hash of pwd
        """
    ...
    def is_valid_password(self, pwd):
        """
        Validate a password:
        - Return False if pwd is None or not a string
        - Return False if no password is set
        - Otherwise, compare stored hash with MD5 hash of pwd
        """
        if pwd is None or type(pwd) is not str:
            return False
